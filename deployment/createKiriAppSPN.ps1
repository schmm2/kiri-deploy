Invoke-Command {
    ...
    $RessourceAccessAPI = New-Object -TypeName "Microsoft.Open.AzureAD.Model.RequiredResourceAccess"
    ...
    Connect-AzureAD
    $App = New-AzureADApplication -DisplayName $AppName -AvailableToOtherTenants $true -GroupMembershipClaims "SecurityGroup" -RequiredResourceAccess @($RessourceAccessApp, $RessourceAccessAPI)
