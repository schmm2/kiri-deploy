Invoke-Command {
    $AppName = "svc-kiriapi777"
    $ReplyUri = "https://testkiri777-backend.azurewebsites.net/.auth/login/aad/callback"
    ...
    $App = New-AzureADApplication -DisplayName $AppName -AvailableToOtherTenants $true -HomePage $AppHomePage -ReplyUrls $ReplyUri -RequiredResourceAccess $RequiredGrants
